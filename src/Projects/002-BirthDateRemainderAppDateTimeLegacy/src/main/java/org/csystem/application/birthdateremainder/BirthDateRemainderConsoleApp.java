/*----------------------------------------------------------------------------------------------------------------------
    ...
    "doğum gününüzü şimdiden kutlarız" mesajlarından birisini ekrana bastıran programı yazınız. Programda
    org.csystem.util.datetime.DateTime sınıfı kullanılmıştır
----------------------------------------------------------------------------------------------------------------------*/
